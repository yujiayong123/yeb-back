...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue queue() {
        return new Queue(MailContants.MAIL_QUEUE_NAME);
    }

    @Bean
    public DirectExchange directExchange() {
        return new DirectExchange(MailContants.MAIL_EXCHANGE_NAME);
    }

    @Bean
    public Binding binding() {
        return BindingBuilder.bind(queue()).to(directExchange()).with(MailContants.MAIL_ROUTING_KEY_NAME);
    }
}
